  ...
  async function connectWallet() {
    ...
    try {
      ...
      try {
        ...
        setIsCurrentMinter(false);
        setStatus(
          "Wallet connected but contract is unavailable on this network. Check the contract address and network."
        );
        toast.error(
          "Wallet connected, but could not read the contract. Verify network/address."
        );
      }
    } catch (err) {
